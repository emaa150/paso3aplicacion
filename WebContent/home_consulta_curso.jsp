...
<body>
        ...
        <section class="container mt-5">
          ...
          <h4></h4>
              ...
              <table class="table table-bordered table-dark table-hover">
                <thead>
                  <tr class="bg-warning">
                      ...
                      <th scope="col">NOMBRE ALU</th>
                     <th scope="col">APELLIDO ALU</th>
              ...
              <c:forEach var="consulta" items="${CONSULTA_CURSO}">  
                ...
                <tbody>
                  <tr >
                     <td class="color-td">${consulta.nombre}</td>
                     <td class="color-td">${consulta.apellido}</td> 
                    <td class="color-td">${consulta.nombrecurso}</td>
                    <td class="color-td">${consulta.nombre_docente}</td>
                    <td class="color-td">${consulta.apellido_docente}</td>
                    <td class="color-td">${consulta.fecha_insc_asignatura}</td>
