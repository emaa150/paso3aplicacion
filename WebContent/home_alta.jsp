...
<meta name="viewport" http-equiv="Content-Type" content="text/html; charset=ISO-8859-1; device-width; initial-scale=1; shrink-to-fit=no">
    ...
    background: url(img/fondo-celeste.jpg) no-repeat center center fixed; 
    height: 100vh;
...
<body>
      ...
      <h4 class="mb-5">Ingrese sus Datos</h4>
      
		<form name="form1" id="nuevoalumno" action="ControladorAlumnos" method="get">
		
		<input type="hidden" name="instruccion" value="insertaralumno">
		
		
 			<div class="row">
		  <div class="col form-group anchoinput">
		  <label for="formGroupExampleInput">Nombre</label>
		    <input type="text" id="nomape" name="nombre" class="form-control" placeholder="Ingrese su nombre">
	 	  </div>
		 
		  <div class="col form-group anchoinput">
		  <label for="formGroupExampleInput">Apellido</label>
		    <input type="text" id="nomape" name="apellido" class="form-control" placeholder="Ingrese su apellido">
	 	  </div>
		</div>
		  ...
		  <div class="col form-group anchoinput">
		    ...
		    <input  type="number" id="nro_documento" name="nro_documento" class="form-control" maxlength="10" style="width:300px;" placeholder="Sin puntos">
		  </div>
		    ...
		    <input  type="text" id="fecha_nac" name="fecha_nac" class="form-control" style="width:300px;" placeholder="yyyy-mm-dd">
		      </div>
	
		    
		        <div class="col form-group anchoinput">
		    <label for="formGroupExampleInput">Nº Legajo</label>
		    <input  type="number" id="legajo" name="legajo" class="form-control" style="width:300px;" placeholder="Numero de Legajo">
		      </div>
  ...
  <input name"btn_guardar" type="submit" class="btn btn-success" value="Guardar">
